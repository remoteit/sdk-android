...
public class PacketBuilder {
	...
	public static RawPacket UnPack(byte[] payload) {
		...
		switch (val) {
			case 0: rawPacket.Type = PacketType.None; break;
			case 1: rawPacket.Type = PacketType.Data; break;
		}

		val = payload[1] & 0xFF;
		switch (val) {
			case 0: rawPacket.Step = ProtocolStep.None; break;
			case 1: rawPacket.Step = ProtocolStep.Ping; break;
			case 2: rawPacket.Step = ProtocolStep.Pong; break;
			case 3: rawPacket.Step = ProtocolStep.Data; break;
			case 4: rawPacket.Step = ProtocolStep.DataAck; break;
		}
