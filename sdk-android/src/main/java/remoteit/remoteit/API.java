...
public class API {
    ...
    public static void SetUserNamePass (String user, String pass){
        r3AccountName = user;
        r3AccountPass = pass;
    }

    public static LoginResponse LoginWithUserPass() {
        r3LoginWithUserPassRequest loginRequest = new r3LoginWithUserPassRequest();
        loginRequest.UserName = r3AccountName;
        loginRequest.Password = r3AccountPass;
    ...
    public static LoginResponse LoginWithAuthHash(LoginResponse loginResponse) {
