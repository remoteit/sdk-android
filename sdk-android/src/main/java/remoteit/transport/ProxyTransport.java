...
import remoteit.networking.Helpers;
import remoteit.remoteit.API;
import remoteit.remoteit.LoginResponse;
import remoteit.remoteit.R3CreateProxyResponse;
    ...
    public void Connect() {
        ...
        new Thread(() -> {
            try {
                ...
                this.loginResponse = API.LoginWithUserPass();
                ...
                remoteit.helpers.Helpers.ReportException(LogTag, e);
                this.Disconnect();
            }
        }).start();
    }
